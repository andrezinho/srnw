<?php 
    ...
    $plantilla = str_replace('"times new roman"',"'Times New Roman'",$plantilla);
?>
<script type="text/javascript" src="<?php echo $urlDir; ?>/srnw/js/jquery-1.7.2.min.js"></script>
...
<head>
	...
	<link type="text/css" rel="stylesheet" href="<?php echo $urlDir; ?>/srnw/js/tinymce/skins/lightgray/content.min.css">
    <link type="text/css" rel="stylesheet" href="<?php echo $urlDir; ?>/srnw/editor/estilos.css">
  <link type="text/css" rel="stylesheet" href="<?php echo $urlDir; ?>/srnw/editor/estilos.css" media="print">
    <style>
...
#viaje_externo { position:absolute; padding:180px 0 0 40px !important;}
#viaje_interno {position:absolute; padding:180px 0 0 43px !important;}
