...
<table width="450" border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <td align="center" bgcolor="#CC9900" style="font-size:12px">Editar Kardex</td>
  </tr>
<?php		
if ($Op!=4)
{
...
?>
<?php 
$Sq="SELECT idkardex FROM kardex 
     WHERE idatencion='$IdAtencion' AND anio='".$_POST['0formD'.$i.'_anio']."' AND idnotaria='".$_SESSION["notaria"]."'";
 $Consq = $Conn->Query($Sq);
 $rq = $Conn->FetchArray($Consq);
 $Cq = $rq[0];
...
<td align="center" style="padding-right:5px; font-size:12px"><a href="#" onclick="editkardex(<?php echo $Cq;?>);"><img src="<?php echo $_SESSION["urlDir"];?>imagenes/iconos/modificar.png" title="Editar Kardex"></a></td>
</tr>
<?php
        if ($Op==2){
            if ($rowCorr[0]==1){
