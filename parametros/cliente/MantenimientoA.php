...
<form id="formP" name="formP" method="post" action="guardar.php?<?php echo $Guardar;?>">
    ...
    <input type="text" class="ui-widget-content ui-corner-all text" style="width:100px;" name="dni_ruc" id="DniRuc" value="<?php echo isset($row[3])?$row[3]:'';?>" <?php echo $Enabled;?>  title="Ingrese el numero del documento" onkeypress="" />
